    ...
    <div className="min-h-screen bg-stone-50 py-8 px-4">
      <div className="max-w-7xl mx-auto animate-fade-in">
        <div className="flex flex-wrap justify-between items-center gap-4 mb-6">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-stone-900 tracking-tight">Ride Requests</h1>
            <p className="text-stone-600 mt-1">Manage your trips and ride requests</p>
          </div>
          <button
        ...
        {trips.length === 0 ? (
          <div className="card p-8 sm:p-12 text-center">
            ...
            <h2 className="text-xl font-semibold text-stone-900 mb-2">No trips yet</h2>
            <p className="text-stone-600 mb-6">Create your first trip to start receiving ride requests</p>
            <button
              onClick={() => navigate('/driver/create-trip')}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  {trips.map((trip) => (
                    ...
                    >
                      <div className="flex justify-between items-start mb-2">
                        ...
                        <span
                          className={`badge ${trip.status === 'SCHEDULED'
                              ? 'badge-info'
            ...
            <div className="lg:col-span-2">
              <div className="card p-5">
                ...
                {!selectedTrip ? (
                  <p className="text-stone-600">Select a trip to view ride requests</p>
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-stone-600">Passengers will see your trip and can request to join</p>
                  </div>
                ) : (
